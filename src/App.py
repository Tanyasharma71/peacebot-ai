...
# -------------------------------------------------
# Paths (adapted for peacebot/src)
# -------------------------------------------------
...
def get_moodlog():
    ...
    try:
        ...
        return jsonify({"error": "Cannot read mood log"}), 500
...
def post_mood():
    ...
    try:
        ...
        return jsonify({"error": "Cannot save mood"}), 500


@app.route("/mood")
def mood_page():
    """Mood Tracker web page."""
    html = """
...
def log_gratitude_interactive_safe():
    ...
    try:
        ...
        return "💫 Let's reflect — 3 things you're grateful for today."
    except Exception as e:
        logger.error(f"Gratitude log error: {e}")
        return "Couldn't save gratitude, but take a mindful pause."
